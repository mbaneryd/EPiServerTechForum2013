(function($) {
    ...
    $.widget("ui.epiPager", {
        ...
        _addPrevButtons: function() {
            ...
            var self = this;
            var options = this.options;
            var firstButton = (this.firstButton = this._addPage(false, "&laquo;", function() { self.goToPage(1, $(this)); return false; }));
            var previousButton = (this.previousButton = this._addPage(false, "&lsaquo;", function() { self.goToPage(options.currentPage - 1, $(this)); return false; }));
        },
        ...
        _addNextButtons: function() {
            ...
            var self = this;
            var options = this.options;
            var nextButton = (this.nextButton = this._addPage(false, "&rsaquo;", function() { self.goToPage(options.currentPage + 1, $(this)); return false; }));
            var lastButton = (this.lastButton = this._addPage(false, "&raquo;", function() { self.goToPage(self._pages, $(this)); return false; }));
        },
        ...
        _addPage: function(selected, text, clickMethod, insertAfterTarget) {
            ...
            if (typeof clickMethod !== "function") {
                clickMethod = function() { self.goToPage(text); return false; };
            }
