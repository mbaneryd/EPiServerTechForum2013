...
$.widget("ui.daterange", {
    ...
    _init: function() {
        ...
        this._startViewElement.bind('click', function() { _this.show(); });
        this._endViewElement.bind('click', function() { _this.show(); });
        ...
        this._startDatePicker.datepicker('option', 'onSelect', function() { _this._selecting(); });
        this._endDatePicker.datepicker('option', 'onSelect', function() { _this._selecting(); });
    },
