(function ($) {
    ...
    $.widget("ui.epiNavigation", {
        ...
        _makeNavigation: function () {
            ...
            this.element.bind("layoutchange", function () { $.event.trigger("/epi/shell/globalnavigation/layoutchange"); });
        ...
        _initMoreMenu: function () {
            ...
            $(window).resize(function (e) {
                if (self._isResizing) { return; }
                self._isResizing = true;
                self._removeMoreMenuItem();
                self._createMoreMenuItem();
                setTimeout(function () { self._isResizing = false; }, 200); // to prevent hang of the IE6
            });
