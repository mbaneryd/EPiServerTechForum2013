(function($, epi) {
    ...
    $.widget("ui.epiGadget", {
        ...
        _toolbarSetup: function() {
            ...
            if (o.removable) {
                $(".epi-iconToolbar-delete", this.element).bind("click", function(e) { self._deleteBtnClickHandler(e); });
            } else {
        ...
        _enableFocus: function() {
            var self = this;
            var keyDownEventHandler = function(e) { self._onKeyDown(e); };
            var contextmenuEventHandler = function(e) { self._contextmenuEventHandler(e); };
            ...
            .bind("blur", function(e) { self._removeActiveGadgetEventHandlers() });
