    ...
    $.widget("ui.epiTabView", {
        ...
        _addTabSettings: function(tab) {
            ...
            tab.addClass(o.tabClass)
                    .attr("role", "tab")
                    .attr("tabindex", -1)
                    .keydown(function(e) { if (!o.disabled) self._navigateOnArrowKeys(e); })
                    .keydown(function(e) { if (!o.disabled) return self._navigateOnSpecialKeyCombinations(e); })
                    .keypress(function(e) { if (!o.disabled) e.stopPropagation(); })
                    .click(function(e) { if (!o.disabled) self.select($(this).closest("li").prevAll().length); e.preventDefault(); });
        },
        ...
        _createTabMenu: function() {
            ...
            var menuButtons = {
                contextMenuButton: {
                    ...
                    click: function(e) { if (!o.disabled) { self._showContextMenu(); } }
                }
            };
            ...
            if (o.removable) {
                menuButtons.deleteButton = {
                    ...
                    click: function(e) { if (!o.disabled) { self.remove(self.selectedTabIndex); } }
                };
            }
            ...
            this.contextMenu.bind("epimenuclick", function(e, clickedItem) { self._contextMenuClickHandler(e, clickedItem); })
        ...
        _show: function(index, shouldSetFocusOnTab) {
            ...
            if (!li.hasClass(o.addButtonLiClass)) {
                ...
                if (this.menuEnabled) {
                    ...
                    this.tabs.eq(index).bind("contextmenu", function(e) { if (!o.disabled) { return self._showContextMenu(); } });
                }
            } else {
                if (this.menuEnabled) {
        ...
        _createArgs: function(index) {
            ...
            /// </param>
            if (!index) { index = this.selectedTabIndex; }
            return {
