(function($) {
    ...
    $.widget("ui.epiContextMenu", {
        _init: function() {
            ...
            this.element.keydown(function(e) { self._keyDownHandler(e); })
                        .keypress(function(e) { e.stopPropagation(); }); // To prevent other eventListeners from stopping click on menu items.
        ...
        show: function(event) {
            ...
            window.setTimeout(function() { self._setSelected(0); self._isOpening = false; }, 1);
